...
class SignDistilBertForTokenClassification(Module):
    ...
    def __init__(self, model_path=None, num_labels=4) -> None:
        ...
        self.model = DistilBertForTokenClassification.from_pretrained(model_path, num_labels=num_labels)
...
class SignDistilBertForSequenceClassification(Module):
    ...
    def __init__(self, model_path=None, num_labels=4, problem_type=None) -> None:
        super().__init__()
        if model_path is None:
            model_path = 'distilbert-base-uncased'
        
        self.model_path = model_path
        self.model = DistilBertForSequenceClassification.from_pretrained(model_path, num_labels=num_labels, problem_type=problem_type)
